...
<Navbar />
    ...
    <div class="flex min-h-full my-24 bg-blue-50 mx-auto w-2/3 flex-1 flex-col justify-center px-6 py-12 lg:px-8 rounded-lg">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 class="my-5 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Write your email to reset password</h2>
        </div>
        <div class="my-5 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" @submit.prevent="authStore.forgotPassword(email)">
                <div v-if="authStore.status" class="mx-2 my-2 text-green-800 font-semibold bg-green-400 rounded-lg">
                    {{ authStore.status }}
                </div>
                ...
                <div class="flex items-center mx-2">
                    <button type="submit"
                        class="text-white bg-blue-500 hover:bg-white hover:text-blue-500 hover:border border-blue-500 font-medium rounded-lg text-sm mx-4 px-4 py-2 text-center">
                    ...
                    <!-- <p class="my-3 text-center text-sm text-gray-500">Didn't get a message?
                        <RouterLink to="/register" class="font-semibold leading-6 text-blue-700 hover:text-blue-800">Resend</RouterLink>
                    </p> -->
                </div>
            </form>
        </div>
