        ...
        <form @submit.prevent="addCar">
            <div class="bg-white p-7 rounded-lg shadow-lg w-auto grid gap-2 md:grid-cols-3">
                ...
                <div class="mb-4">
                    ...
                    <select v-model="car_category" type="text" class="w-full p-2 border border-gray-300 rounded mt-1" required>
                ...
                <div class="mb-4">
                    ...
                    <input v-model="registration_number" type="text" class="w-full p-2 border border-gray-300 rounded mt-1" required/>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700">Brand</label>
                    <input v-model="brand" type="text" class="w-full p-2 border border-gray-300 rounded mt-1" required/>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700">Model</label>
                    <input v-model="model" type="text" class="w-full p-2 border border-gray-300 rounded mt-1" required/>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input v-model="mileage" type="text" class="w-full border border-gray-300 rounded" required/>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700">Seats</label>
                    <input v-model="seats" type="text" class="w-full p-2 border border-gray-300 rounded mt-1" required/>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700">Gearbox</label>
                    <input v-model="gearbox" type="text" class="w-full p-2 border border-gray-300 rounded mt-1" required/>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700">Price</label>
                    <input v-model="price" type="text" class="w-full p-2 border border-gray-300 rounded mt-1" required/>
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700">Fuel</label>
                    <select v-model="fuel" type="text" class="w-full p-2 border border-gray-300 rounded mt-1" required>
                ...
                <div class="mb-4">
                    ...
                    <input v-model="is_available" type="text" class="w-full p-2 border border-gray-300 rounded mt-1" required/>
                </div>
                <div class="mb-4">
