        ...
        <form @submit.prevent="updateCar">
            <div class="bg-white p-7 rounded-lg shadow-lg w-auto grid gap-2 md:grid-cols-3">
                ...
                <div class="mb-1 col-span-3">
                    ...
                    <select v-model="car.car_category_id" type="text" class="w-full p-1 border border-gray-300 rounded" required>
                ...
                <div class="mb-1">
                    ...
                    <input v-model="car.registration_number" type="text" class="w-full p-1 border border-gray-300 rounded" required/>
                </div>
                <div class="mb-1">
                    <label class="block text-gray-700">Brand</label>
                    <input v-model="car.brand" type="text" class="w-full p-1 border border-gray-300 rounded" required/>
                </div>
                <div class="mb-1">
                    <label class="block text-gray-700">Model</label>
                    <input v-model="car.model" type="text" class="w-full p-1 border border-gray-300 rounded" required/>
                </div>
                <div class="mb-1">
                    <label class="block text-gray-700">Mileage</label>
                    <input v-model="car.mileage" type="text" class="w-full p-1 border border-gray-300 rounded" required/>
                </div>
                <div class="mb-1">
                    <label class="block text-gray-700">Seats</label>
                    <input v-model="car.seats" type="text" class="w-full p-1 border border-gray-300 rounded" required/>
                </div>
                <div class="mb-1">
                    <label class="block text-gray-700">Gearbox</label>
                    <input v-model="car.gearbox" type="text" class="w-full p-1 border border-gray-300 rounded" required/>
                </div>
                <div class="mb-1">
                    <label class="block text-gray-700">Price</label>
                    <input v-model="car.price" type="text" class="w-full p-1 border border-gray-300 rounded" required/>
                </div>
                <div class="mb-1">
                    <label class="block text-gray-700">Fuel</label>
                    <select v-model="car.fuel_options_id" type="text" class="w-full p-1 border border-gray-300 rounded" required>
                ...
                <div class="mb-1">
                    ...
                    <input v-model="car.is_available" type="text" class="w-full p-1 border border-gray-300 rounded" required/>
                </div>
                <div class="mb-1 col-span-3">
                    <label class="block text-gray-700">Image</label>
                    <input v-on:change="handleImageChange" type="file" class="w-full border border-gray-300 rounded" />
                </div>
                <div class="mb-1 col-span-3">
                    <label class="block text-gray-700">Description</label>
                    <textarea v-model="car.description" class="w-full p-1 border border-gray-300 rounded" required></textarea>
                </div>
