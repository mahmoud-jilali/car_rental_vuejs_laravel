...
onMounted(async() => {
    await rentalsStore.getCurrentRentals()
})
...
<template>
    ...
    <div class="relative overflow-x-auto">
        ...
        <template v-else-if="rentalsStore.CurrentRentals">
            <table class="w-5/6 mx-auto text-sm text-left rtl:text-right text-gray-900">
                ...
                <tbody>
                    <tr v-for="rental in rentalsStore.CurrentRentals" class="bg-white border-b border-x">
