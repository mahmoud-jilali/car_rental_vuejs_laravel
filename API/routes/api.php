...
Route::get('/old_rentals', [RentalController::class, 'getOldRentals'])->middleware('auth:sanctum');
Route::get('/current_rentals', [RentalController::class, 'getCurrentRentals'])->middleware('auth:sanctum');
Route::get('/new_rentals', [RentalController::class, 'getNewRentals'])->middleware('auth:sanctum');
